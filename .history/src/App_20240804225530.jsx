...
function App() {
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/todos') // Modified line
      .then(response => {
  ...
  const saveToJSON = (updatedTodos) => { // Added function
    axios.put('http://localhost:3001/todos', updatedTodos) // Modified line
      .then(response => {
        setTodos(response.data)
      })
      .catch(error => {
