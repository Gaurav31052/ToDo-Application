              ...
              <div key={item.id} className='flex flex-col w-[40vw]'> 
                <div className='flex justify-between'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <button onClick={() => toggleExpand(item.id)} className='bg-violet-700 rounded-md w-auto p-1 text-white hover:bg-violet-500  hover:border'>{expandedTodoId === item.id ? 'Less ' : 'More info'}</button> 
                  </div>
                </div>
