        ...
        <div className="w-[50vw] bg-purple-400 min-h-screen m-8 p-10 rounded-lg ">
          ...
          <div className='text-xl font-bold m-3'>
           ...
           <div className='gap-4 flex'>
            ...
            <button onClick={handleAdd} disabled={todo.length<3} className='bg-violet-700 rounded-md w-20 text-white hover:bg-violet-500 && border-white border-300'>Save</button>
           </div>
