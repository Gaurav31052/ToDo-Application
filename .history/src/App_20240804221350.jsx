        ...
        <div className="w-[50vw] bg-purple-400 min-h-screen m-8 p-10 rounded-lg ">
          ...
          <div className='text-xl font-bold m-3'>
           ...
           return(showFinished || !item.isCompleted) && <div key={item.id} className='flex w-[40wv] justify-between'>
              ...
              <button onClick={(e)=>{handleEdit(e,item.id)}} className='bg-violet-700 rounded-md w-auto p-1 text-white hover:bg-violet-500  hover:border-2'>Edit</button>
              <button onClick={(e)=>{handleDelete(e,item.id)}} className='bg-violet-700 rounded-md w-auto p-1 text-white hover:bg-violet-500  hover:border-2'>Delete</button>
              </div>
            </div>
